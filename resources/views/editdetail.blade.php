...
<body>
    <form class="row g-3 justify-content-center" method="post" action="{{url('editdetail')}}">
        @csrf
        ...
        <div class="field_wrapper">
            ...
            <div class="col-6">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="hobby[]" value="{{ $hobbys}}" aria-label="hobby"
                        aria-describedby="basic-addon2">
                    <button class="btn btn-danger" type="button" href="javascript:void(0);" title="Add field">-</button>
                </div>
            </div>
            @endforeach
            <div class="col-6">
